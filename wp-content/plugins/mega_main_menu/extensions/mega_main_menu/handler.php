 ...
 */
	...
	function mmm_set_walkers ( $args ){
		...
		if ( ( is_array( $mega_menu_locations ) && in_array( $theme_location_safe_name, $mega_menu_locations ) ) || ( $indefinite_location_mode === true ) || ( $args['theme_location'] == 'mega_main_sidebar_menu' ) || ( $args['theme_location'] == 'mega_main_flyout_menu' ) ) {
			...
			$args['menu_id'] = 'mega_main_menu_ul'.$mega_menu_location_id;
			...
			$items_wrap = '';
			$items_wrap .= mm_common::ntab(0) . '<!-- begin "mega_main_menu" -->';
			$items_wrap .= mm_common::ntab(0) . '<div id="mega_main_menu'. $mega_menu_location_id  .'" class="' . $container_class_imploded . ' mega_main mega_main_menu">';
