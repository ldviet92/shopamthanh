...
function vgpc_body_monday($post_id)

{
...

	{
		...
		#vgpc-wrapper'.$post_id.' .vgpc-item-i .vgpc-post-readmore a,
		#vgpc-wrapper'.$post_id.' .vgpc-item-i .vgpc-post-category {

			background:  '.$vgpc_ilink_color.';
	...
	$vgpc_html .= '<div id="vgpc-wrapper'.$post_id.'" class="vgpc-wrapper theme-monday owl-carousel '.$vgpc_class_sufix.'">';
...

				{
					...
					$vgpc_html .= '<div class="vgpc-item-i">';
...

						{
							...
							$vgpc_html .= '<div class="vgpc-post-category">'.__("", "vgpc").$vgpc_categories.'</div>';
						...
						if($vgpc_post_title || $vgpc_post_author || $vgpc_post_date || $vgpc_post_desc)
...

	{
		...
		jQuery(document).ready(function($) {
			...
			$("#vgpc-wrapper'.$post_id.'").owlCarousel({
				...
				navigationText: 	["'.__("<", "vgpc").'", "'.__(">", "vgpc").'"],
