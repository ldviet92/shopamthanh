...
function vgpc_body_wednesday($post_id)

{
...

	{
		...
		#vgpc-wrapper'.$post_id.' .vgpc-item-i .shadow {
			
			background:  '.$vgpc_ibg_color.';
	...
	$vgpc_html .= '<div id="vgpc-wrapper'.$post_id.'" class="vgpc-wrapper theme-wednesday owl-carousel '.$vgpc_class_sufix.'">';
...

			{
...

				{
					...
					$vgpc_html .= '<div class="vgpc-item-i">';
						...
						$vgpc_html .= '<span class="shadow"></span>';
						

						if($vgpc_post_title || $vgpc_post_author || $vgpc_post_date || $vgpc_post_desc || $vgpc_readmore)
