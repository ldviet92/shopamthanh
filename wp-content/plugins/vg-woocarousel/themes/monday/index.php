<?php
function vgwc_body_monday($post_id)
{
	...
	/* HTML Block */
	$vgwc_html .= '<div id="vgwc-wrapper'.$post_id.'" class="vgwc-wrapper theme-monday owl-carousel '.$vgwc_class_sufix.'">';
		if($vgwc_total_items)
		{
			for($i = 0; $i < $vgwc_total_loop; $i ++)
			{
				...
				for($m = 0; $m < $vgwc_row_carousel; $m ++)
				{
					...
					$vgwc_html .= '<div class="vgwc-item-i">';
						...
						if($vgwc_product_name || $vgwc_product_rating || $vgwc_product_price)
						{
