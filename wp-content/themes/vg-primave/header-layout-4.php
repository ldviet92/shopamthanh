...
<div class="wrapper box-layout <?php if($primave_options['page_style']=='box'){echo 'box-layout';}?>">
	<!-- Top Header -->
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-3 header-right">
							...
							<div class="vg-user">
								<?php echo wp_nav_menu(array("theme_location" => "menu-login", 'fallback_cb' => false, "")); ?>
							</div>
