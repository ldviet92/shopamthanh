...
$primave_projectsfound  = primave_get_global_variables('primave_projectsfound');
...
$projects_loop['columns'] = $primave_options['portfolio_columns'];
...
<?php if ((0 == $projects_loop['loop'] % 2 || $primave_projectsfound == $projects_loop['loop']) && ($projects_loop['columns'] == 2)) { /* for odd case: $primave_projectsfound == $projects_loop['loop'] */
	if($primave_projectrows!=1) {
		echo '</div>';
	}
} ?>