...
$wpdb  = primave_get_global_variables('wpdb');
...
<div class="main-container page-portfolio full-width">
	<div class="container">
		...
		?>
		<div class="related_projects widget">
			<h3 class="related-title vg-title"><span><?php echo esc_html($primave_options['related_project_title']); ?></span></h3>
			<?php
