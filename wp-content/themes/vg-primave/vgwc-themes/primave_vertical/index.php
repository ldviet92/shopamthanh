<?php
function vgwc_body_primave_vertical($post_id)
{
	...
	/* HTML Block */
	$vgwc_html .= '<div id="vgwc-wrapper'.$post_id.'" class="vgwc-wrapper theme-primave vertical-primave owl-carousel '.$vgwc_class_sufix.'">';
		if($vgwc_total_items)
		{
						...
						$vgwc_html .= '<div class="ma-box-content">';
							...
							if($vgwc_product_image)
							{
								$vgwc_html .= '<div class="vgwc-image-block">';
									$vgwc_html .= '<a href="'.get_permalink().'" title="'.get_the_title().'">';
										$vgwc_html .= '<img alt="'.get_the_title().'" data-src="'.$vgwc_thumb_url.'" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="  class="primary_image wp-post-image lazy"/>';		$vgwc_html .= $image_second;
									$vgwc_html .= '</a>';					
